...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { title: @sector.title, user_id: @sector.user_id } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { title: @sector.title, user_id: @sector.user_id } }
