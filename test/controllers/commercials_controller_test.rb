...
class CommercialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commercial" do
    assert_difference('Commercial.count') do
      post commercials_url, params: { commercial: { address: @commercial.address, avatar: @commercial.avatar, category_id: @commercial.category_id, city_id: @commercial.city_id, description: @commercial.description, phone: @commercial.phone, user_id: @commercial.user_id } }
    end
  ...
  test "should update commercial" do
    patch commercial_url(@commercial), params: { commercial: { address: @commercial.address, avatar: @commercial.avatar, category_id: @commercial.category_id, city_id: @commercial.city_id, description: @commercial.description, phone: @commercial.phone, user_id: @commercial.user_id } }
