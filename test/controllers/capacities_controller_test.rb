...
class CapacitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create capacity" do
    assert_difference('Capacity.count') do
      post capacities_url, params: { capacity: { title: @capacity.title, user_id: @capacity.user_id } }
    end
  ...
  test "should update capacity" do
    patch capacity_url(@capacity), params: { capacity: { title: @capacity.title, user_id: @capacity.user_id } }
